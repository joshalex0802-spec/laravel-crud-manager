...
<div class="max-w-5xl mx-auto px-4">
    ...
    <h3 class="text-3xl md:text-5xl font-light mb-12 md:mb-20 tracking-tighter uppercase text-center">Seleccionar Módulo</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <a href="/gestion/{{$link}}" class="glass p-8 md:p-10 hover:border-emerald-500 transition-all group border border-white/5 block">
